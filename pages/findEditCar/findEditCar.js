...
const fetchAndPopulateCar = async () => {
    ...
    try {
        ...
        document.getElementById("fetch-status").innerText = "Car fetched and fields populated"
    } catch (err) {
...
export function initFindEditCar() {
    document.getElementById("btn-fetch-car").onclick = async () => await fetchAndPopulateCar()
    document.getElementById("btn-submit-edited-car").onclick = async () => await handleSubmitChange()
    document.getElementById("btn-delete-car").onclick = async () => await handleDeleteCar()
}
